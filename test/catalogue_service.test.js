...
describe("catalogueService.getBooksByAuthor", () => {
  test("returns a list of books written by a given author", () => {
    expect(catalogueService.getBooksByAuthor("Charles Dickens")).toEqual(["A Tale of Two Cities by Charles Dickens", "Oliver Twist by Charles Dickens","Great Expectations by Charles Dickens"]);
  });
});